...
```{r aves adult mass, include=FALSE}
ggplot(aves, aes(x=female_maturity_d, y=adult_body_mass_g)) +
  geom_point() + 
  scale_x_continuous(limits = c(0, 1000)) + 
  labs(title="Aves, Mass v. Maturity", x="Age at Female Maturity (days)",
       y="Adult Body Mass (g)")
```

```{r mammalian adult mass, include=FALSE}
ggplot(mammalia, aes(x=female_maturity_d, y=adult_body_mass_g)) +
  geom_point() + 
  labs(title="Mammalia, Mass v. Maturity", x="Age at Female Maturity (days)",
       y="Adult Body Mass (g)")
```

```{r reptilia adult mass, include=FALSE}
ggplot(reptilia, aes(x=female_maturity_d, y=adult_body_mass_g)) +
  geom_point() + 
  labs(title="Reptilia, Mass v. Maturity", x="Age at Female Maturity (days)",
       y="Adult Body Mass (g)")
```
