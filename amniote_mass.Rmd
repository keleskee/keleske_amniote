...
mammalia$baby_rate <- mammalia$birth_or_hatching_weight_g * mammalia$litter_or_clutch_size_n * mammalia$litters_or_clutches_per_y /mammalia$adult_body_mass_g / mammalia$gestation_d
reptilia$baby_rate <- reptilia$birth_or_hatching_weight_g * reptilia$litter_or_clutch_size_n * reptilia$litters_or_clutches_per_y / mammalia$adult_body_mass_g / reptilia$gestation_d

```

```{r mammalian rate comp,  eval=TRUE, echo=FALSE}
ggplot(mammalia, aes(x=adult_rate, y=baby_rate)) +
  geom_point() + 
  labs(title="Mammalia", x="Adult Growth Rate (g/day)",
       y="Relative Offspring Growth Rate (g/g/day)") +
  geom_smooth(aes(x=adult_rate, y=baby_rate), color="red")
```

```{r mammalian rate comp,  eval=TRUE, echo=FALSE}
ggplot(reptilia, aes(x=adult_rate, y=baby_rate)) +
  geom_point() + 
  labs(title="Reptilia", x="Adult Growth Rate (g/day)",
       y="Relative Offspring Growth Rate (g/g/day)") +
  geom_smooth(aes(x=adult_rate, y=baby_rate), color="blue")
```
